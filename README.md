...
Various types of crawlers do exits. They are typically grouped into categories such as focused, collaborative, incremental, parallel, distributed and mobile. The specific details will vary widely. The Following images is an example of a focused web crawler's high level architecture reproduced from (Bal, 2012). 

![focused wen crawler](./images/focusedcrawler.png)

**Figure 1: Focused web crawler**
